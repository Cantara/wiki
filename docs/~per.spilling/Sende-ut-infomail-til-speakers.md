# Sende ut infomail til speakers

| Tittel | Sende ut infomail til speakers (Sendes ut sammen med Speakers dinner RSVP) |
| --- | --- |
| Prioritet | A |
| --- | --- |
| Ansvarlig | Øyvind Løkling |
| --- | --- |
| Status | Ferdig |
| --- | --- |

### Notater
Skal vi sende ut en mail eller flere?
- deadline for levering av slides
- info om program
