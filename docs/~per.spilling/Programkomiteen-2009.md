...
(Ref. felles planlegging 20. april)

    * 25. mai Ferdig første kategorisering og feedback på sendt.
...
|  | Hvor |  |
| --- | --- | --- |
|  | JavaBlackBelt? forum http://www.javablackbelt.com/forum/forums/list.page |
|  | Java Ranch |  |
|  | InfoQ |
| (/) | The Server Side (http://www.theserverside.com/discussions/thread.tss?thread_id=54115&m=d.post) Digged @ digg.com |
| (/) | Twitter |
|  | alles blogg - linket inn i topptjenester? javablogs..? |
|  | generelt profilerte bloggere |
| (/) | Conferences-tråden på forum.java.net: http://forums.java.net/jive/forum.jspa?forumID=126(http://forums.java.net/jive/ann.jspa?annID=247) |
|  | Öredev |
|  | Gr8Cond (Danmark ?) |
|  | java.no |

### Informasjon for mailutsending

http://www.verticalresponse.com/ brukernavn: kjetil@java.no passord: javaBin08
