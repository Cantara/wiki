...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://maven.apache.org/POM/4.0.0 http://maven.apache.org/maven-v4_0_0.xsd">
  ...
  <artifactId>cinclus-parent-jsw-daemon-webapp</artifactId>
  <version>2</version>
  <packaging>pom</packaging>
  <name>TnC JSW Daemon Webapp Parent</name>
  ...
  <scm>
    <connection>
      scm:svn:svn+ssh://svn.telenorcinclus.local/var/local/repos/cinclus_common/lib/cinclus-parent-jsw-daemon-webapp
    </connection>
    <developerConnection>
      scm:svn:svn+ssh://svn.telenorcinclus.local/var/local/repos/cinclus_common/lib/cinclus-parent-jsw-daemon-webapp
    </developerConnection>
  ...
  <build>
    ...
    <plugins>
            ...
            <daemon>
              ...
              <jvmSettings>
                <systemProperties>
                  ...
                  <!-- can't set this at present, it moves the databases if WEBAPP_BASE is not set
                  <systemProperty>derby.system.home=%WEBAPP_BASE%/logs</systemProperty>
                  -->
      ...
      <plugin>
        ...
        <configuration>
          <contact>FS-Team-Platform, Erik Drolshammer</contact>
          <contactEmail>fs-team-platform-dev@cinclus.com</contactEmail>
  ...
  <properties>
    ...
    <rpm.groupname>cinclus-amm</rpm.groupname>
