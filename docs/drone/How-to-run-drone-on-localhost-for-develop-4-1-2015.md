...
4. Start Tomcat
5. Build and install auke-service module by mvn clean install (e.g make auke-service.jar after build success)
6. Start service by command: java -jar auke-service.jar server src/main/resources/app-config.yaml
