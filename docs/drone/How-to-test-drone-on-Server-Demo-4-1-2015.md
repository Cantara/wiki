...
3. Zoom out positions on map and take ~10s then look drones moving in current boundary/zoom

Notes: this is just draft version, I and Huy stilling continuos improvement and upgrade every days from Leif's Support.

Issues: Since every 10s send request into server maybe impact performance when load map API from google also for drones on map

Good luck!

**see also:** [Service calls](Service-calls.md)
