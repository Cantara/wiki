...
![http://wiki.cantara.no/download/attachments/10816140/CiA-banner_comm.png](http://wiki.cantara.no/download/attachments/10816140/CiA-banner_comm.png)
    ...
    * Tema: Integrasjon
    * Twittertags: #iasa #integration #CiA2010
...
Kan man se på integrasjonsspøkelset som et tre-hodet monster? Og dermed bryte ned problemstillingen til gode løsninger på følgende områder?
    * Anti corruption layer (Data/kilde) 
    * Distribusjon 
    * Mapping, prosess og flyt
...
1800 - Se **[Program for Communities in Action 2010](http://wiki.cantara.no/display/PE/Program+Communities+in+Action+2010)**
2030 - Sosialt
2130 - Un-conference
