...
1. RC performs authentication against Whydah, _on behalf<sub>~of_ IcaBus, with the username and a hash of the clear</sub>~text password and gets a token back. 
