...
The Artefact contains default properties for the different [IAM\_MODE](/web/20211206025923/https://wiki.cantara.no/display/whydah/IAM_MODE "IAM_MODE")'s being used.
...
| --- | --- | --- | --- | --- |
| **prop.type** | PROD | TEST | DEV | [IAM\_MODE](/web/20211206025923/https://wiki.cantara.no/display/whydah/IAM_MODE "IAM_MODE") for this property file |
