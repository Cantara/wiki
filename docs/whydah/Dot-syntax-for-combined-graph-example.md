# Dot syntax for combined graph example
...
digraph G {
	...
	stores [label="Orgnization
 of Stores",shape=Mdiamond];
	...
	singleStore -> gs  
	singleStore [label="Orgnization
 of Grocery Store",shape=Mdiamond];
	...
	prodfirm -> pf 	
	prodfirm [label="Orgnization of Production Company",shape=Mdiamond];

	subgraph access{
		node [color=Red,fontname=Courier,shape=box]
		edge [color=Blue, style=dashed]
		Karen->Region2 [label="hasAccess", fontcolor=darkgreen]
		Karen->Store20 [label="noAccess", fontcolor=red]
	}

	subgraph admin{
		node [color=Red,fontname=Courier,shape=box]
		edge [color=Blue, style=dashed]
		pm->Store16 [label="isAdmin", fontcolor=darkgreen]
		pm->Region2 [label="isAdmin", fontcolor=darkgreen]
		dev->Freezer4 [label="isAdmin", fontcolor=darkgreen]
	}
