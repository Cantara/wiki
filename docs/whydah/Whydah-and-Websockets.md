...
- Noe vi bør se på hvordan vi støtter er whydah i real-time context. Les: skrive anbefaling kanskje.
 Tenker spesiellt på web<sub>~sockets/mobil</sub>~api
 push/pull
...
### Scenarios*
- jeg er ikke helt sikker på om jeg helt skjønner use<sub>~caset, annet enn det jo er "kjekt å ha" .  blir f.eks veldig sticky</sub>~sessions med websockets :simple_smile:
...
- jeg kan se at nede i **app<sub>~2</sub>~app** protokollen kan nyttiggjøres snetralisert koordinering av nøkkelbytter og slikt dog
