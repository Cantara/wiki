# Load test Whydah 2.0 rc-2

### Background

We want to ensure the robustness and scale ability of all stable Whydah releases

### Test set-up

Version tested:  
- **Whydah 2.0<sub>~rc</sub><sub>2**  30.9</sub><sub>2014  15:00</sub>~16:00 GST+1
