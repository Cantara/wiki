...
An architect must strive to achieve certain [qualities](/web/20210306165446/https://wiki.cantara.no/display/architecture/Architect+qualities "Architect qualities").
...
It is also important to establish clear and consistent responsibilities in the organization. Some notes on this can be found in [Architect roles and responsibilities](/web/20210306165446/https://wiki.cantara.no/display/architecture/Architect+roles+and+responsibilities "Architect roles and responsibilities").

#### Policies/Rules and how to challenge them

|  | **Rules applicability** Rules are applicable in a certain context. If a project is not in the given context, the rule does not apply. |
...
| Create rules based on:   Context   Domain | - |
| - | Tooling and patterns   Select technology |

|  | Apply [Vær-varsom plakaten for arkitekten](http://brodwall.com/johannes/blog/2009/04/22/v%c3%a6r-varsom-plakaten-for-arkitekten/). |
...
![Læring i roller](../images/gliffy/2064513-Læring-i-roller.png)
...
- Communicate business domain knowledge to tech lead.
  - [Understand The Business Domain](http://97-things.near-time.net/wiki/Understand%20The%20Business%20Domain)  by Mark Richards
