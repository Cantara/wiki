...
|  | [complex data](complex-data.md) | [KM:large data](../KM/large-data.md) | [high reads](high-reads.md) | [high writes](high-writes.md) | [KM:compute<sub>~process](../KM/compute</sub>~process.md) |
| --- | --- | --- | --- | --- | --- |
...
| [KM:os<sub>~cloud](../KM/os</sub>~cloud.md) | *[L | scale complex data in the os & cloud layer]*  | *[L | scale large data in the os & cloud layer]*  | *[L | scale high read in the os & cloud layer]*  | *[L | scale high write in the os & cloud layer]*  | *[L | scale high processing or high computational in the os & cloud layer]*  |
