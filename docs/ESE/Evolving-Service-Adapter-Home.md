# Evolving Service Adapter Home

- [Evolving Service Endpoint Pattern](http://wiki.community.objectware.no/display/OWSOA/Evolving+Service+Endpoint+Pattern)
- [Service Dialect Adapter pattern implemented as JAX-WS handler](http://wiki.community.objectware.no/display/OWSOA/Service+Dialect+Adapter+pattern+implemented+as+JAX-WS+handler)
...
- [Consumer-Driven Contracts: A Service Evolution Pattern](http://martinfowler.com/articles/consumerDrivenContracts.html)
- [Service Dialect Adapter pattern implemented as JAX-WS handler](/web/20210415074158/https://wiki.cantara.no/display/OWSOA/Service+Dialect+Adapter+pattern+implemented+as+JAX-WS+handler "Service Dialect Adapter pattern implemented as JAX-WS handler")
