...
- The [Task Board](http://confluence.atlassian.com/display/GH/Using+the+Task+Board) to show you the work-queue for a version or component. 
    - [Training for Scrum Task Board Use](http://www.mountaingoatsoftware.com/scrum/task-boards)

- The [Chart Board](http://confluence.atlassian.com/display/GH/Using+the+Chart+Board) which will show you the burn-down chart for a sprint. The chart board offers the following graphs:
