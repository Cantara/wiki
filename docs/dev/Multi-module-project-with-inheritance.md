...
1. Move modules into their own separate project 
    ...
    - Domain classes, message classes/formats and [helpers](../architecture/Helper-code-as-separate-projects.md) are good candidates for separate projects. 
