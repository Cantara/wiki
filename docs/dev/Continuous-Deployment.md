...
1. The Continuous Deployment process detects the new application and copies it into a deployment folder (see for example [How to deploy to IBM WebSphere 6.x](How-to-deploy-to-IBM-WebSphere-6-x.md))
...
See also [Continuous deployment in 5 easy steps](http://radar.oreilly.com/2009/03/continuous-deployment-5-eas.html), [Why Continuous Deployment?](http://startuplessonslearned.blogspot.com/2009/06/why-continuous-deployment.html)
