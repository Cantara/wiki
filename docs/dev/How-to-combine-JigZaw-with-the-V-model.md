...
The [V-model](http://en.wikipedia.org/wiki/V-Model_(software_development)) groups tests into **unit tests**, **integration tests**, **system tests** and **acceptance tests**. To model big distributed systems, higher granularity and additional levels / test types is needed. 
...
See [JigZaw Test Levels](JigZaw-Test-Levels.md) for descriptions of each test level.
