...
We are using Github as a repository for our code. Everyone has read access. The main HTML is located in dashboard.html, and the scripts of interest are located in the scripts-folder. See [http://github.com/ivarconr/html5-codecamp](http://github.com/ivarconr/html5-codecamp) for these files.
