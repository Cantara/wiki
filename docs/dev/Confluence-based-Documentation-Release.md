...
- [Export documentation to html](http://confluence.atlassian.com/display/DOC/Confluence+to+HTML)

- Check it into a [Version Control System](http://en.wikipedia.org/wiki/Revision_control).
