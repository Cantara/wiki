...
Maven can be configured to use almost any directory structure and so can the scm plugin. However, in the spirit of _convention over configuration_ we strongly recommend that you follow the trunk, tags, branches convention when using Subversion. See [SVN best practices](http://svn.collab.net/repos/svn/trunk/doc/user/svn<sub>~best</sub><sub>practices.html), [Choosing a Repository Layout](http://svnbook.red</sub><sub>bean.com/en/1.0/ch05s04.html#svn</sub><sub>ch</sub><sub>5</sub><sub>sect</sub><sub>6.1) and [Release Branches](http://svnbook.red</sub><sub>bean.com/en/1.1/ch04s04.html#svn</sub><sub>ch</sub><sub>4</sub><sub>sect</sub>~4.4.1) for more on this convention. 
