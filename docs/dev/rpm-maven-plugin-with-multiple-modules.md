...
If, for some reasons (legacy), you need to define your RPM packaging into your parent POM, the following configuration should be done to avoid rpm<sub>~maven</sub>~plugin to be called by each module:
