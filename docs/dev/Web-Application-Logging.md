...
- Split DEBUG<sub>~files from WARN</sub>~files, and from ERROR-files

ERROR<sub>~log files are just for ERROR</sub>~level log statements. These are the ones that should wake you up in the middle of the night by SMS, phone-call, etc.
