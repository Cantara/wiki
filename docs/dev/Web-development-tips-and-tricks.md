...
[Minify JavaScript and CSS](http://developer.yahoo.com/performance/rules.html#minify) can be done by the following tools: 
...
- [FireBug](https://addons.mozilla.org/firefox/1843/) \- Debugger, DOM-navigation, XMLHttpRequest monitor \++.
    - [YSlow](http://developer.yahoo.com/yslow/) 
    - Web Developer
- [Venkman](http://www.mozilla.org/projects/venkman/) \- Heavy debugger, used to be the best but is probably behind Firebug by now.
- [JavaScript shell](http://www.squarefree.com/shell/) \- Interactive JavaScript shell (bookmarklet for Firefox)
