...
|  |  |
| --- | --- |
| 1. Deploy snapshots Unknown macro: {gliffy} | 2. Release Unknown macro: {gliffy} |

#### Implementation recommendations

- [Organizing Maven projects](/web/20230531231415/https://wiki.cantara.no/display/dev/Organizing+Maven+projects "Organizing Maven projects")
- [Repository Management](/web/20230531231415/https://wiki.cantara.no/display/dev/Repository+Management "Repository Management")
- [CI recommendations](/web/20230531231415/https://wiki.cantara.no/display/dev/CI+recommendations "CI recommendations")
- [Version Control System tips and tricks](/web/20230531231415/https://wiki.cantara.no/display/sysadm/Version+Control+System+tips+and+tricks "Version Control System tips and tricks")
- [Technical site and reporting](/web/20230531231415/https://wiki.cantara.no/display/dev/Technical+site+and+reporting "Technical site and reporting")
- [Automatic code review](/web/20230531231415/https://wiki.cantara.no/display/dev/Automatic+code+review "Automatic code review")
- [Agile Project Communication](/web/20230531231415/https://wiki.cantara.no/display/dev/Agile+Project+Communication "Agile Project Communication")
