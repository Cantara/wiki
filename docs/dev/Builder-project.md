...
One of the reasons why some people cling to the _"Everything in one project"_ approach is that it is convenient to build all code with a single command. This convenience can also be achieved with a so called builder project ("samlepom" in Norwegian). 
