...
This example will try to demonstrate an simple implementation of the Enterprise Domain Repository pattern.
Features demonstrated is:
- Read and update of address information from two different providers (simulated databases).
- Use of the correlator.
- Implementation of all elements in Enterprise Domain Repository

### [Use Search Engine to store Credit Rating Example](https://edr.dev.java.net/source/browse/**checkout**/edr/trunk/examples/java/Examle_With_SearchEngine/readme.html)
