...
- [EDR - The details](/web/20100823233734/http://wiki.cantara.no/display/EDR/EDR+-+The+details "EDR - The details")
- [EDR - Pattern diagram](/web/20100823233734/http://wiki.cantara.no/display/EDR/EDR+-+Pattern+diagram "EDR - Pattern diagram")

|  |  |
| --- | --- |
| The Java implementation(s).  - [[Java Implementation Details]]  EDR on dev.java.net  - [EDR](https://edr.dev.java.net/) - [Join](https://edr.dev.java.net/servlets/ProjectMemberList) - [Browse SVN](https://edr.dev.java.net/source/browse/edr/)  EDR implemented as a Composite Object Programming multi backend EntityStore  - [Qi4j EDR implementation](/web/20100823233734/http://wiki.cantara.no/display/EDR/Qi4j+EDR+implementation "Qi4j EDR implementation") | The .net/C# implementation.  - [.Net (C#)]  The .Net examples will be made publicly available later. |
...
- [Community Corner at JavaOne 2008](/web/20100823233734/http://wiki.cantara.no/download/attachments/6815745/EDR-JavaOne-08.pdf?version=1&modificationDate=1213261264800)
- [EDR as Integration Strategy at Communities in Action 2010 (Norwegian)](/web/20100823233734/http://wiki.cantara.no/download/attachments/6815745/EDR_as_Integration_Strategy_at_CiA2010.pdf?version=1&modificationDate=1273578072506)
...
The [Recording Command Pattern](/web/20100823233734/http://wiki.cantara.no/display/EDR/Recording+Command+Pattern "Recording Command Pattern") may be used to extend the Providers used by the Enterprise Domain Respository. A Recording Gateway will keep track of all executed commands and record all responses to these requests. This enables the gateway to go into offline mode and do playback of the traffic should the provided system be unavailable.

[Merge Strategy Pattern](/web/20100823233734/http://wiki.cantara.no/display/EDR/Merge+Strategy+Pattern "Merge Strategy Pattern")  
[Merge Timing Pattern]  
[Open-ended Integration Merge Pattern](/web/20100823233734/http://wiki.cantara.no/display/EDR/Open-ended+Integration+Merge+Pattern "Open-ended Integration Merge Pattern")  
[Data Mapping in EDR](/web/20100823233734/http://wiki.cantara.no/display/EDR/Data+Mapping+in+EDR "Data Mapping in EDR")  
...
[Moderator Discussion](/web/20100823233734/http://wiki.cantara.no/display/EDR/EDR+-+Moderator "EDR - Moderator")
