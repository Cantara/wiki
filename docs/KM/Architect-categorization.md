...
We use **Product Architect** to classify architects who work on a specific product and *whithin* the product lifeline scope. Commonly used names for such architects are: Chief Product Architect, Product Architect, System Architect, Sub-system Architect, Build Architect or *Tech leads*.
