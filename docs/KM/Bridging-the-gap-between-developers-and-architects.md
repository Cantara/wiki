...
- require that all applications *must* use the Spring IoC container.
- require that only Spring 1.2.x can be used, not for example 2.5
- only axis 1.1
- etc.

Can anyone give me an example where this *is* a good idea?   
...
See [Software Architect - Ivory\_towers](http://en.wikipedia.org/wiki/Software_Architect#Ivory_towers)

See [Learning circle](/web/20090623042244/http://wiki.cantara.no/display/KM/Learning+circle "Learning circle")
