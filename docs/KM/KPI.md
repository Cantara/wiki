...
Thus being more customer-centric requires a company to quantify it's performance and work to improve it. In the case of the examples above, things like response time, site downtime, number of failed upgrades, time to perform a release, bug counts and feature count against cost of delivery can be used as metrics to indicate how we're doing in our mission to make the customer happy. 

Reference:
- [Pragmatic Dictator - Quantitative](http://www.dancres.org/blitzblog/2009/05/18/quantitative/) (Dan Creswell)

**KPI Definition**

- [Key_performance_indicators](http://en.wikipedia.org/wiki/Key_performance_indicators) (wikipedia)
