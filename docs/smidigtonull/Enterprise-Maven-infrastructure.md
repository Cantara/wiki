...
|  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- |
| 1. Deploy snapshots  |  |  | | --- | --- | | [Full Size](/web/20100615233027/http://wiki.cantara.no/spaces/gliffy/viewlargediagram.action?name=Enterprise+Maven+Infrastructure+-+snapshots&ceoid=5472430&key=smidigtonull&pageId=5472430)  |  | | | 2. Release  |  |  | | --- | --- | | [Full Size](/web/20100615233027/http://wiki.cantara.no/spaces/gliffy/viewlargediagram.action?name=Enterprise+Maven+Infrastructure+-+release&ceoid=5472430&key=smidigtonull&pageId=5472430)  |  | | |

#### Implementation recommendations

- [Organizing Maven projects](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/Organizing+Maven+projects "Organizing Maven projects")
- [Repository Management](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/Repository+Management "Repository Management")
- [CI recommendations](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/CI+recommendations "CI recommendations")
- [Version Control System tips and tricks](/web/20100615233027/http://wiki.cantara.no/display/sysadm/Version+Control+System+tips+and+tricks "Version Control System tips and tricks")
- [Technical site and reporting](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/Technical+site+and+reporting "Technical site and reporting")
- [Automatic code review](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/Automatic+code+review "Automatic code review")
- [Agile Project Communication](/web/20100615233027/http://wiki.cantara.no/display/smidigtonull/Agile+Project+Communication "Agile Project Communication")
