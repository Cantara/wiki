...
See [Java Parent POM Example](/web/20100615233012/http://wiki.cantara.no/display/smidigtonull/Java+Parent+POM+Example "Java Parent POM Example") for a complete pom.
