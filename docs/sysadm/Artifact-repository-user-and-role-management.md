...
1. Create new _hosted_ repositories: project1-releases and project1-snapshots 
...
[http://books.sonatype.com/nexus-book/reference/security-privileges.html](http://books.sonatype.com/nexus-book/reference/security-privileges.html)
