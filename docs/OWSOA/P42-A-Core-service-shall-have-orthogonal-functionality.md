...
| Doc status | [H2A](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/H2A "H2A") | [A2A](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/A2A "A2A") | [ACS](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/ACS "ACS") | [CS](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/CS "CS") | Last [PAB](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/PAB "PAB") discussion |
| --- | --- | --- | --- | --- | --- |
|  |  |  |  |  | 2007.06.08 |
...
### [Design-Time Governance - SOA Design Rules FAQ](/web/20210621064237/https://wiki.cantara.no/display/OWSOA/Design-Time+Governance+-+SOA+Design+Rules+FAQ "Design-Time Governance - SOA Design Rules FAQ")
