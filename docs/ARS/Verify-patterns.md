...
When selecting the patterns that you plan to use in a release you need to verify these carefully. 
 
## Check strengths and weaknesses
Each pattern has a number on intrinsic strengths and weaknesses. Carefully examine the strengths and weaknesses of the patterns being evaluated in the context of your project. Small changes in a project can render a promising pattern useless.

## User groups
When defining a [MRP](MRP.md) strategy in a project make sure to test it against all user groups. A strategy can look promising until you see that it will not work for one user group. 
