...
### Outsourced print
In Google Docs the print function simply creates a PDF document and then opens a PDF-viewer. The user then prints by using the print function in the PDF-viewer. By "outsourcing" the problem of printing Google Docs avoided having to support all the intricacies of printing in an early release. The penalty for the user is relatively minor, an extra click on Print in the PDF-viewer.
