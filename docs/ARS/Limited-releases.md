...
- Reduced [MDE](/web/20090929115148/http://wiki.cantara.no/display/ARS/MDE "MDE")  
  It is easier to get acceptance for limiting functionality in the [MDE](/web/20090929115148/http://wiki.cantara.no/display/ARS/MDE "MDE") if only a few users will be affected. Since only a few users will be using the release, the [MDE](/web/20090929115148/http://wiki.cantara.no/display/ARS/MDE "MDE") can focus on main stream features and ignore special cases.
...
One prerequisite for a limited release is that it is possible to discern whether the system will be able to handle a task before work is started. Users will be very frustrated if they get halfway through a task and then realize that it cannot be completed. In a [Replacement project](/web/20090929115148/http://wiki.cantara.no/display/ARS/Replacement+project "Replacement project") or [Enhancement project](/web/20090929115148/http://wiki.cantara.no/display/ARS/Enhancement+project "Enhancement project") this problem can be mitigated by using the [Facilitate switching](/web/20090929115148/http://wiki.cantara.no/display/ARS/Facilitate+switching "Facilitate switching") principle.
